...
<template>
  ...
  >
    <div class="w-full">
      ...
      <div v-reveal="{ delay: 100, variant: 'scale' }" class="mt-[38px] max-[768px]:mt-[22px]">
        <div
        ...
        >
          ...
          >
            <img
              ...
              :alt="item.alt"
              draggable="false"
              class="motion-image pointer-events-none block h-full w-full select-none object-cover"
            />
          </article>
        </div>
      </div>
