...
const props = defineProps({
  title: {
    type: String,
    default: 'Хотите оформить своё событие?',
  },
  description: {
    type: String,
    default: 'Оставьте заявку, и мы подберём идеальное оформление под ваш стиль и площадку',
  },
  submitLabel: {
    type: String,
    default: 'Заказать оформление',
  },
})
