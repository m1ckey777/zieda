...
const { t } = useLanguage()
const aboutIcons = [aboutIcon1Url, aboutIcon2Url, aboutIcon3Url]
const aboutItems = computed(() => t.value.home.about.items.map((item, index) => ({ ...item, icon: aboutIcons[index] })))
</script>
