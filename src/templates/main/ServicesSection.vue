  ...
  <section id="services" class="mx-auto w-[min(1200px,calc(100%-40px))] pb-[110px] max-[768px]:w-[min(1200px,calc(100%-32px))] max-[768px]:pt-[72px] max-[768px]:pb-[82px]">
    ...
    <div class="mt-12 grid items-stretch gap-9 min-[1100px]:grid-cols-3 max-[1099px]:grid-cols-1 max-[768px]:mt-10 max-[768px]:gap-8">
      <article
        ...
        :key="card.title"
        class="flex h-full flex-col overflow-hidden rounded-[24px] bg-white shadow-[0_20px_45px_rgba(34,17,46,0.08)] max-[768px]:overflow-visible max-[768px]:rounded-none max-[768px]:bg-transparent max-[768px]:shadow-none"
      >
        <img :src="card.image" :alt="card.title" class="block h-[264px] w-full object-cover max-[768px]:h-[444px] max-[768px]:rounded-[8px]" />
